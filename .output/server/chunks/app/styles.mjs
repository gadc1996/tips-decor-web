...
const IndexHero_vue_vue_type_style_index_0_scoped_d031ec6d_lang = ".index-hero[data-v-d031ec6d]{background-color:#e8efef;padding-top:100px;width:100%}.index-hero .wrapper[data-v-d031ec6d]{align-items:center;display:flex;height:70vh;justify-content:space-around;margin:0 auto;max-width:1200px;width:100vw}.index-hero .wrapper__img[data-v-d031ec6d]{max-height:350px;max-width:450px}";
...
const styles = {
  ...
  "pages/category/[id].vue": () => import('./_nuxt/_id_-styles.ed4be298.mjs').then(interopDefault),
  "pages/note/[id].vue": () => import('./_nuxt/_id_-styles.f45d81a5.mjs').then(interopDefault),
